...
const resources = {
  en: {
    translation: {
      ...
      // Landing Page
      "landing.hero.title": "Where Automation Engineers Level Up",
      "landing.hero.subtitle": "Stop watching tutorials. Start building real n8n workflows that matter. Daily challenges designed by automation experts, powered by AI feedback.",
      "landing.hero.cta": "Start Building Now",
      "landing.hero.demo": "See How It Works",
      "landing.hero.social_proof": "Join 500+ engineers building production-ready automation skills",
      "landing.hero.trial_info": "Free daily challenges • No credit card • Start building today",
      
      "landing.problem.title": "Stop Getting Stuck When It Matters Most",
      "landing.problem.subtitle": "You've watched the tutorials. Read the docs. But when your boss asks you to automate the customer onboarding process, you freeze.",
      "landing.problem.tutorialHell": "Tutorial Trap",
      "landing.problem.tutorialHellDesc": "Hours of theory, zero practice. When real automation challenges hit, you're back to square one.",
      "landing.problem.noPractice": "Zero Real Experience",
      "landing.problem.noPracticeDesc": "Toy examples don't prepare you for messy APIs, complex data transforms, and production edge cases.",
      "landing.problem.noFeedback": "Flying Blind", 
      "landing.problem.noFeedbackDesc": "No idea if your workflows follow best practices or will break under real-world pressure.",
      "landing.problem.skillGaps": "Confidence Gap",
      "landing.problem.skillGapsDesc": "You know the basics, but doubt yourself on anything beyond simple automations.",
      "landing.problem.testimonial": "I binged 47 n8n tutorials and memorized the docs. But when my manager said 'automate our customer onboarding by Friday,' I panicked. I had no clue how to handle real data, error cases, or API limits.",
      "landing.problem.testimonialAuthor": "Sarah Chen",
      "landing.problem.testimonialRole": "Operations Manager",
      
      "landing.features.title": "Build Production-Ready Skills, Not Toy Examples",
      "landing.features.subtitle": "Real challenges • Expert feedback • Measurable progress",
      "landing.features.whyTitle": "Why FlowForge?",
      "landing.features.whySubtitle": "Stop learning theory. Start building workflows that actually work in production. Every challenge is designed by automation experts who've been there.",
      "landing.features.learnByDoing": "Real Business Scenarios",
      "landing.features.learnByDoingDesc": "Customer onboarding, data sync, API integrations - the exact automations companies need built.",
      "landing.features.aiFeedback": "Expert-Level Feedback", 
      "landing.features.aiFeedbackDesc": "AI trained by n8n pros gives you the same feedback you'd get from a senior automation engineer.",
      "landing.features.trackProgress": "Addictive Progress System",
      "landing.features.trackProgressDesc": "XP, streaks, leaderboards. Gamification that actually makes you better, not just engaged.",
      "landing.features.buildPortfolio": "Portfolio That Gets Noticed",
      "landing.features.buildPortfolioDesc": "Showcase real automation projects that prove you can handle production workloads.",
      
      "landing.howItWorks.title": "How FlowForge Works",
      "landing.howItWorks.subtitle": "From automation zero to production hero in 15 minutes per day.",
      "landing.howItWorks.step1": "Get Your Mission",
      "landing.howItWorks.step1Desc": "Daily challenges based on real automation requests from actual companies.",
      "landing.howItWorks.step1Features1": "Story-driven business scenarios",
      "landing.howItWorks.step1Features2": "Beginner to expert difficulty", 
      "landing.howItWorks.step1Features3": "Production-level requirements",
      "landing.howItWorks.step2": "Build Like a Pro",
      "landing.howItWorks.step2Desc": "Code your n8n workflow with professional tooling and smart assistance when you're stuck.",
      "landing.howItWorks.step2Features1": "Pro-grade JSON editor",
      "landing.howItWorks.step2Features2": "Live validation & testing",
      "landing.howItWorks.step2Features3": "Expert hint system",
      "landing.howItWorks.step3": "Get Expert Review",
      "landing.howItWorks.step3Desc": "AI trained by n8n experts analyzes your code like a senior engineer would.",
      "landing.howItWorks.step3Features1": "Detailed performance breakdown",
      "landing.howItWorks.step3Features2": "Production-ready optimization tips",
      "landing.howItWorks.step3Features3": "Best practices enforcement",
      "landing.howItWorks.step4": "Level Up & Dominate",
      "landing.howItWorks.step4Desc": "Track your skills growth, unlock advanced challenges, and prove your expertise.",
      "landing.howItWorks.step4Features1": "Global skill rankings",
      "landing.howItWorks.step4Features2": "Milestone achievements",
      "landing.howItWorks.step4Features3": "Employer-ready portfolio",
      
      "landing.cta.title": "Ready to Build Automations That Actually Work?",
      "landing.cta.subtitle": "Join 500+ engineers who stopped watching tutorials and started building production workflows",
      "landing.cta.button": "Start Building Today",
      "landing.cta.startAutomation": "Start Building Real Automations",
      "landing.cta.journeyToday": "Begin Your Journey",
      "landing.cta.ctaSubtitle": "500+ automation engineers leveling up their skills with real challenges and expert AI feedback.",
      "landing.cta.benefit1": "Daily challenges forever free",
      "landing.cta.benefit2": "No credit card ever",
      "landing.cta.benefit3": "Start building immediately",
      "landing.cta.benefit4": "Expert-level feedback",
      "landing.cta.benefit5": "Production-ready skills",
      "landing.cta.emailPlaceholder": "Enter email to start building",
      "landing.cta.startLearning": "Start Building",
      "landing.cta.trustedBy": "Trusted by automation teams at companies you know",
