...
const resources = {
  ...
  es: {
    translation: {
      ...
      "terms.acceptance.content": "Al acceder y usar este sitio web, aceptas estar sujeto a estos términos y condiciones. Si no estás de acuerdo con alguna parte de estos términos, no debes usar nuestro sitio web.\n\nEstos términos se aplican a todos los visitantes, usuarios y otras personas que acceden o usan el servicio.",
      "terms.description.title": "Descripción del Servicio",
      "terms.description.content": "FlowForge es una plataforma educativa que proporciona desafíos de automatización n8n, retroalimentación impulsada por IA y funciones de comunidad para ayudar a los usuarios a mejorar sus habilidades de automatización de flujos de trabajo.\n\nNos reservamos el derecho de retirar o modificar nuestro servicio, y cualquier servicio o material que proporcionamos en el servicio, a nuestro único criterio sin previo aviso.",
      ...
      "terms.limitation.content": "En ningún caso FlowForge, ni sus directores, empleados, socios, agentes, proveedores o afiliados, serán responsables de daños indirectos, incidentales, especiales, consecuentes o punitivos.",
      "terms.governing.title": "Ley Aplicable",
      "terms.governing.content": "Estos términos se regirán e interpretarán de acuerdo con las leyes del Estado de Delaware, Estados Unidos, sin tener en cuenta sus disposiciones de conflicto de leyes.",
      ...
      "terms.contact.content": "Si tienes alguna pregunta sobre estos términos y condiciones, por favor contáctanos en legal@hackyourflows.com",
      ...
      "privacy.international.content": "Tu información puede ser transferida y mantenida en computadoras ubicadas fuera de tu estado, provincia, país u otra jurisdicción gubernamental donde las leyes de protección de datos pueden diferir.\n\nSi estás ubicado fuera de Estados Unidos y eliges proporcionarnos información, ten en cuenta que transferimos los datos, incluyendo datos personales, a Estados Unidos.",
      ...
      "privacy.contact.content": "Si tienes alguna pregunta sobre esta política de privacidad, contáctanos en privacy@hackyourflows.com",
